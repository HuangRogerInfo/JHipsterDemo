package com.dauphine.journal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.dauphine.journal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dauphine.journal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
